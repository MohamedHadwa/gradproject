...
class GlobalTranslations {
  ...
  Future<Null> setNewLanguage(
    ...
    String jsonContent =
        await rootBundle.loadString("assets/langs/$language.json");
  ...
  Future<String> _getApplicationSavedInformation(String name) async {
    ...
    return prefs.getString(_storageKey + name) ?? 'ar';
  }
...
GlobalTranslations localization = new GlobalTranslations();
